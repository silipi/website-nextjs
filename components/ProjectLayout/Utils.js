...
export function Badges(props) {
  return (
    <img src={`../images/badges/${props.name}.png`} className={styles.badge} />
  )
}
...
export function ProjectDetailsCard(props) {
  ...
  return (
    <div className={styles.cardPanel}>
      <div className={styles.cardImage}><img src={`../images/projects-page/${props.image}`} className={styles.image} /></div>
